...
import { CATEGORY_NAMES, CATEGORY_IMAGES } from '@/lib/constants';
import { motion } from 'framer-motion';
import { MapPin, Layers, Filter, X, ArrowLeft } from 'lucide-react';

const COLORS = ['سفید', 'کرم', 'خاکستری', 'مشکی', 'قهوه‌ای', 'سبز', 'صورتی', 'طلایی', 'عسلی'];
const FINISHES = ['صیقلی', 'هنداسی', 'بوشارد', 'چرمی', 'پولیش', 'سندبلاست'];
